...
# installing ghcr.io/devcontainers-contrib/features/homebrew-package:1.0.0
PACKAGE="mlocate" VERSION="$VERSION" featmake "ghcr.io/devcontainers-contrib/features/homebrew-package:1.0.0"
